...
%symbolic variables
syms Pxw Pyw Pzw yaw pitch roll dpx dpy dpz p q r T tauy taup taur T1 T2 T3 T4;
% symsvector  = [Pxw; Pyw; Pzw ;yaw ;pitch ;roll ;dpx ;dpy ;dpz ;p ;q ;r ;T ;tauy ;taup ;taur];
symsvector  = [Pxw; Pyw; Pzw ;yaw ;pitch ;roll ;dpx ;dpy ;dpz ;p ;q ;r ;T1 ;T2 ;T3 ;T4];

% Transformation matrix from individual thrusts to total thrusts and
% torques
M = controlHelperParams.Ts2Q;
...
p_ddot          = Global2Body*[0;0;quad.g] + M(1,:)*[T1;T2;T3;T4]/quad.M*[0;0;1] -cross(transpose([p,q,r]),transpose([dpx,dpy,dpz]));
...
o_ddot          = inv(J)*(M(2:4,:)*[T1;T2;T3;T4] - cross([p;q;r],J*[p;q;r]));
